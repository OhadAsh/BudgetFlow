          ...
          {!hasResult && (
            <>
              <ExcelFileDropArea
                ...
                title={
                  mode === 'bank'
                    ? 'גרור לכאן דוחות עובר ושב מהבנק (xlsx) או לחץ לבחירה'
                    : 'גרור לכאן דוחות עסקאות מכאל או ממקס (xlsx) או לחץ לבחירה'
                }
                subtitle={
                  mode === 'bank'
                    ? 'מייבאים זכות כהכנסות, וחובה כהוצאות: הו״ק, שיקים ומשיכות מזומן. כרטיסי אשראי וניירות ערך מסוננים אוטומטית. נתמך 100% בדיסקונט.'
